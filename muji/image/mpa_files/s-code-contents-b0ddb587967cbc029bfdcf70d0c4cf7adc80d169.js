...
s.linkInternalFilters="javascript:,muji.com/tw,st3gb.muji.net,www.muji.tw"
...
//Config variables for channelManager
//s._extraSearchEngines="";
s._channelDomain="Google ProductSearch|www.google.de/products>YouTube|youtube.com>Twitter|twitter.com,twSearch|ittergadget.com,t.co>FaceBook|facebook.com";
//s._channelParameter="";
s._channelPattern="Mail Magazine|em_>CRITEO|bn_criteo_"

function s_doPlugins(s) {
	/* Add calls to plugins here */
        s.campaign=s.getQueryParam('sc_cid');
        s.prop11=s.getQueryParam('sc_cid');
	s.prop7=s.getPercentPageViewed();
	s.prop8=s.getPreviousValue(s.pageName,'gpv_pn');
        s.eVar2=s.getQueryParam('sc_fid');

	//channelManager v2.4
	s.channelManager('sc_cid','','0','0','sc_cm','1');
	s.eVar9=s._keywords.replace("+"," ");
	s.eVar10=s._partner;
	s.eVar11=s._channel;

  var sc_domain=location.hostname;
  if(sc_domain.match(/www\.muji\.com|www\.muji\.tw/)){
  s.un = "mjimujitwprd";
  } else {
  s.un = "mjimujitwdev";
  }
...
//search engine list for channelManager plug-in
s.seList="ask.com|ask,q|Ask Jeeves>baidu.com,"
+ "baidu.jp|wd,word|Baidu>daum.net|q|Daum>docomo.ne.jp|key|Docomo>excite."
+ "co.jp|search,s|Excite>goo.ne.jp|MT|Goo>google,googlesyndication.com|q,"
+ "as_q|Google>kakaku.com|query|Kakaku>livedoor.com|q|Livedoor.com>bing.c"
+ "om|q|Microsoft Bing>msn|q|MSN>naver.com|query|Naver>nifty.com|q|Nifty>"
+ "odn.excite.co.jp|search|ODN>yahoo.com,yahoo.co.jp|p,va|Yahoo!>";
